...
class Apple:
    ...
    def process_micrograph(
        ...
        while True:
            ...
            segmentation, segmentation_proba = picker.run_svm(score)
        ...
        centers = picker.extract_particles(segmentation, segmentation_proba)

        particle_image = None
        if create_jpg and centers is not None and self.output_dir is not None:
