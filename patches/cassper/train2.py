...
# model_checkpoint_name=args.dataset+"checkpoints/latest_model_"+ args.frontend + "_" + args.model + "_" + os.path.basename(args.dataset) + ".ckpt"
model_checkpoint_name=args.dataset+"checkpoints/latest_model_"+ args.frontend + "_" + args.model + ".ckpt"
old_epoch=0
...
train_input_names = [val.replace(cwd,'').replace("//",'/') for val in train_input_names]
train_output_names = [val.replace(cwd,'').replace("//",'/') for val in train_output_names]
val_input_names = [val.replace(cwd,'').replace("//",'/') for val in val_input_names]
val_output_names = [val.replace(cwd,'').replace("//",'/') for val in val_output_names]
test_input_names = [val.replace(cwd,'').replace("//",'/') for val in test_input_names]
test_output_names = [val.replace(cwd,'').replace("//",'/') for val in test_output_names]
del cwd
