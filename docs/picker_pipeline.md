...
```bash
# move all boxfiles out of subdirectories into BOX/
mkdir -p ${DATASET_HOME}/relion/autocryopicker/BOX_tmp/
mv ${DATASET_HOME}/relion/autocryopicker/BOX/*/*.box ${DATASET_HOME}/relion/autocryopicker/BOX_tmp/
rm -r ${DATASET_HOME}/relion/autocryopicker/BOX/
mv ${DATASET_HOME}/relion/autocryopicker/BOX_tmp/ ${DATASET_HOME}/relion/autocryopicker/BOX/
```
